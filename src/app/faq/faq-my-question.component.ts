...
@Component({
    selector: 'content',
    templateUrl: 'faq-my-question.component.html'
})
export class FAQMyQuestionComponent implements OnInit, OnDestroy{
    ...
    ngOnInit(): void {
        this.faqService.listMyQuestions(1).then(questions => {
    ...
    showMore() {
        this.faqService.listMyQuestions(this.pagedList.pageNum + 1)
            .then(
                questions => {
